...
import { SkillDefinition } from '../agent/types';

/** 订单查询技能 */
export const orderInquirySkill: SkillDefinition = {
  name: 'orderInquiry',
...
/** 投诉处理技能 */
export const complaintSkill: SkillDefinition = {
...
/** 退款申请技能 */
export const refundSkill: SkillDefinition = {
...
/** 产品咨询技能 */
export const productConsultSkill: SkillDefinition = {
  name: 'productConsult',
